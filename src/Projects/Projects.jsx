                    ...
                    <Box sx={{ margin: '10px' }}>
                        ...
                        <Box m={1} mt={2}>
                            <Stack component={Link} to='https://echoes.fyi' sx={{ ':hover': { cursor: 'pointer' }, textDecoration: 'none' }} direction="row" alignItems="center" gap={1} >
                                <Typography variant='h6' sx={{ color: color, fontFamily: 'Rubik' }}>Echoes.fyi</Typography>
                            ...
                            <Box m={1} maxWidth={'50vh'}>
                                <Typography variant='body1' sx={{ color: '#FFFFFF', fontFamily: 'Rubik' }}>2023 - Awaiting Spotify Approval</Typography>
                                <Box m={1} maxWidth={'50vh'}>
                                    <Typography variant='body1' sx={{ fontSize: { xs: '.9em', sm: '1em', xl: '1em' }, color: '#CCCCCC', fontFamily: 'Rubik' }}>Echoes.fyi is an individual project built to assist users in retrieving and filtering song recommendations, viewing personal account statistics, and viewing track analyses. This was designed according to Spotify Design Guidelines. Full Track Streaming is available to users with premium accounts.</Typography>
                                </Box>
                                <Box m={1} maxWidth={'50vh'}>
                                    <Typography variant='body1' sx={{ fontSize: { xs: '.9em', sm: '1em', xl: '1em' }, color: '#CCCCCC', fontFamily: 'Rubik' }}>ReactJS Web Application which consumes the Spotify Web API and Spotify Playback SDK. Deployed via CloudFlare. Graphics created via Photoshop.</Typography>
                                </Box>
                            </Box>
                        </Box>
                        <Box m={1} mt={2}>
                            <Stack component={Link} to='https://m-mills.com' sx={{ ':hover': { cursor: 'pointer' }, textDecoration: 'none' }} direction="row" alignItems="center" gap={1} >
                                <Typography variant='h6' sx={{ color: color, fontFamily: 'Rubik' }}>Portfolio</Typography>
                                <IconButton ><Box component={'img'} src={'./BulletPoint.png'} sx={{ width: '15px', transition: '.3s', ':hover': { width: '18px', filter: 'brightness(5)' } }}></Box></IconButton>
                            </Stack>
                            <Box m={1} maxWidth={'50vh'}>
                                <Typography variant='body1' sx={{ color: '#FFFFFF', fontFamily: 'Rubik' }}>2023</Typography>
                                <Box m={1} maxWidth={'50vh'}>
                                    <Typography variant='body1' sx={{ fontSize: { xs: '.9em', sm: '1em', xl: '1em' }, color: '#CCCCCC', fontFamily: 'Rubik' }}>What you're currently looking at! </Typography>
                                </Box>
                                <Box m={1} maxWidth={'50vh'}>
                                    <Typography variant='body1' sx={{ fontSize: { xs: '.9em', sm: '1em', xl: '1em' }, color: '#CCCCCC', fontFamily: 'Rubik' }}>ReactJS Web Application utilizing ThreeJS for background graphics. SVGs were created using Photoshop. 3D Model was created using Blender.</Typography>
                                </Box>
                            </Box>
                        </Box>
                        <Box m={1} mb='50px'>
                            <Stack component={Link} to='https://appsource.microsoft.com/en-us/product/office/WA200005492?tab=Overview' sx={{ ':hover': { cursor: 'pointer' }, textDecoration: 'none' }} direction="row" alignItems="center" gap={1}>
                                <Typography variant='h6' sx={{ color: color, fontFamily: 'Rubik' }}>CobbleStone Add-In for Word</Typography>
                                <IconButton ><Box component={'img'} src={'./BulletPoint.png'} sx={{ width: '15px', transition: '.3s', ':hover': { width: '18px', filter: 'brightness(5)' } }}></Box></IconButton>
                            </Stack>
                            <Box m={1} maxWidth={'50vh'}>
                                <Typography variant='body1' sx={{ color: '#CCCCCC', fontFamily: 'Rubik' }}>2022 - 2023</Typography>
                                <Box m={1} maxWidth={'50vh'}>
                                    <Typography variant='body1' sx={{ fontSize: { xs: '.9em', sm: '1em', xl: '1em' }, color: '#CCCCCC', fontFamily: 'Rubik' }}>This is an individually developed project created during my time at CobbleStone Software. This project is a web application injected in Word Services (Word Desktop, Word Online, etc.) and sideloaded according to an XML Manifest. This allows for custom ribbon tabs, buttons, and functions.
