                ...
                <Box mb={2} sx={{ margin: '10px' }}>
                    ...
                    <Box m={1} my={2}>
                        ...
                        <Box m={1} maxWidth={'50vh'}>
                            ...
                            <Box m={1} maxWidth={'50vh'}>
                                <Typography variant='body1' sx={{ fontSize: { xs: '.9em', sm: '1em', xl: '1em' }, color: '#CCCCCC', fontFamily: 'sans-serif' }}>During my time at Scranton, I was a member of both Upsilon Pi Epsilon (Computing Honors Society) and the swim team. As of January 2024, I believe I still hold around 4 school records for swimming.</Typography>
                            </Box>
                        </Box>
