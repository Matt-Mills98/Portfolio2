                ...
                <Box mb={2} sx={{ margin: '10px' }}>
                    ...
                    <Box m={1} my={2}>
                        ...
                        <Box m={1} maxWidth={'50vh'}>
                            ...
                            <Box m={1} maxWidth={'50vh'}>
                                <Typography variant='body1' sx={{ color: '#999999', fontFamily: 'sans-serif' }}>Reading has always been a relaxing endeavor for me. I personally enjoy fantasy novels and am currently working my way through Reddit suggestions on my Kindle. </Typography>
                            </Box>
                            <Box m={1} maxWidth={'50vh'}>
                            ...
                            <Box m={1} maxWidth={'50vh'}>
                                <Typography variant='body1' sx={{ color: '#999999', fontFamily: 'sans-serif' }}>When I was much younger, I always had a bit of a knack for art. This led to me perceiving art classes as one of my favorite subjects. Around 12 years old, I began learning Adobe Photoshop and Cinema 4D, using cracked versions on a PC that had no business running these programs. There, I learned logo design, vector creation, basic 3D modeling, and basic design principles among other things. While I continued to take art and graphic design classes through college, these skills gave me a great foundation for much of my front-end development.</Typography>
                            </Box>
                            <Box m={1} maxWidth={'50vh'}>
